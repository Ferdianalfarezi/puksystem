...
<body class="bg-gray-50/50 font-sans antialiased" 
    ...
    <a href="{{ route('dispensasi.index') }}" 
       class="menu-item flex items-center px-3 py-3 rounded-xl text-gray-700 group {{ request()->routeIs('dispensasi.*') && !request()->routeIs('sekretaris.dispensasi.*') && !request()->routeIs('ketua.dispensasi.*') ? 'active' : '' }}"
    ...
    <div x-data="{ open: {{ request()->routeIs('bendahara.*') || request()->routeIs('ketua.*') || request()->routeIs('sekretaris.dispensasi.*') || request()->routeIs('pencairan.*') ? 'true' : 'false' }} }">
        <!-- Parent Menu - Verifikasi -->
        <button @click="open = !open" 
                class="menu-item w-full flex items-center justify-between px-3 py-3 rounded-xl text-gray-700 group {{ request()->routeIs('bendahara.*') || request()->routeIs('ketua.*') || request()->routeIs('sekretaris.dispensasi.*') || request()->routeIs('pencairan.*') ? 'active' : '' }}"
        ...
        <div x-show="open" 
            ...
            @if($userRole === 'sekretaris')
                <a href="{{ route('sekretaris.dispensasi.index') }}" 
                   class="submenu-item flex items-center px-3 py-2 rounded-lg text-sm text-gray-600 hover:bg-gray-100 hover:text-gray-900 transition {{ request()->routeIs('sekretaris.dispensasi.*') ? 'bg-gray-100 text-gray-900 font-semibold' : '' }}">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"/>
                    </svg>
            ...
            @if($userRole === 'ketua')
                ...
                <a href="{{ route('ketua.dispensasi.index') }}" 
                   class="submenu-item flex items-center px-3 py-2 rounded-lg text-sm text-gray-600 hover:bg-gray-100 hover:text-gray-900 transition {{ request()->routeIs('ketua.dispensasi.*') ? 'bg-gray-100 text-gray-900 font-semibold' : '' }}">
                    <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"/>
                    </svg>
                    <span>Dispensasi</span>
            ...
            <!-- SUPERADMIN ROLE - NESTED DROPDOWNS -->
            @if($userRole === 'superadmin')
                ...
                <!-- Parent Sekretaris -->
                <div class="mt-2" x-data="{ open: {{ request()->routeIs('sekretaris.dispensasi.*') ? 'true' : 'false' }} }">
                    <button @click="open = !open"
                        class="flex items-center justify-between w-full px-3 py-2 text-sm rounded-lg 
                            text-gray-700 hover:bg-gray-100 transition">
                        <div class="flex items-center space-x-2">
                    ...
                    <div x-show="open" x-collapse class="ml-6 mt-1 space-y-1">
                        ...
                        class="flex items-center px-3 py-2 text-sm rounded-lg
                                hover:bg-gray-100 text-gray-600 transition
                                {{ request()->routeIs('sekretaris.dispensasi.*') ? 'bg-gray-100 text-gray-900 font-semibold' : '' }}">
                            Dispensasi
                        </a>
                    </div>
                </div>
                ...
                <div class="mt-2" x-data="{ open: {{ request()->routeIs('ketua.*') ? 'true' : 'false' }} }">
                    ...
                    <div x-show="open" x-collapse class="ml-6 mt-1 space-y-1">                    
                        ...
                        class="flex items-center px-3 py-2 text-sm rounded-lg
                                hover:bg-gray-100 text-gray-600 transition
                                {{ request()->routeIs('ketua.dispensasi.*') ? 'bg-gray-100 text-gray-900 font-semibold' : '' }}">
                            Dispensasi
                        </a>
                    </div>
                </div>
