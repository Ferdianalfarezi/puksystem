...
@section('title', 'Konfirmasi Bendahara')
...
<div class="space-y-6">
    ...
    <div class="space-y-4">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold text-gray-900">Konfirmasi Program Kerja</h1>
                <p class="text-gray-600 mt-1">Review dan konfirmasi program kerja dari semua bidang</p>
            </div>
        </div>
            ...
            <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-yellow-900 mt-1">{{ $programKerjas->total() }}</p>
                    </div>
...
<!-- Approve Modal -->
@include('bendahara.approve-modal')
...
<script>
    ...
    document.getElementById('approveForm').addEventListener('submit', async function(e) {
        ...
        try {
            const response = await fetch(`/bendahara/${currentProgramId}/approve`, {
                method: 'POST',
                headers: {
    ...
    document.getElementById('rejectForm').addEventListener('submit', async function(e) {
        ...
        try {
            const response = await fetch(`/bendahara/${currentProgramId}/reject`, {
                method: 'POST',
                headers: {
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content,
                },
