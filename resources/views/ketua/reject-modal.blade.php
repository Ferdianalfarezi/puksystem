    ...
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-2xl transform transition-all duration-300 scale-95">
        ...
        <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200 bg-red-50 rounded-t-2xl">
            <div class="flex items-center space-x-3">
                ...
                <h2 class="text-xl font-bold text-gray-900">Tolak Program Kerja</h2>
            </div>
        ...
        <form id="rejectForm" class="p-6 space-y-4">
            ...
            <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                <div class="flex">
                    ...
                    <div class="text-sm text-yellow-800">
                        ...
                        <p>Anda akan menolak program kerja: <strong id="rejectProgramName"></strong></p>
                        <p class="text-xs text-yellow-600 mt-2">
                            Penolakan dari Ketua bersifat final. Program tidak akan dapat dilanjutkan.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="flex space-x-3 pt-4">
                ...
                <button type="submit"
                    class="flex-1 bg-red-500 text-white px-4 py-3 rounded-lg font-semibold hover:bg-red-600 transition flex items-center justify-center space-x-2">
