<!-- REJECT Modal Ketua -->
<div id="rejectModalKetua" class="fixed inset-0 hidden items-center justify-center z-50 p-4 bg-black bg-opacity-50 backdrop-blur-sm transition-opacity duration-300 opacity-0">
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-2xl transform transition-all duration-300 scale-95">
        ...
        <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200 bg-red-50 rounded-t-2xl">
            ...
            <button onclick="closeRejectModalKetua()" class="text-gray-400 hover:text-gray-600 transition">
        ...
        <!-- Modal Body -->
        <form id="rejectFormKetua" class="p-6 space-y-4">
            @csrf
            ...
            <div class="bg-red-50 border border-red-200 rounded-lg p-4">
                <div class="flex">
                    ...
                    <div class="text-sm text-red-800">
                        ...
                        <p class="mt-1">Anda akan menolak pengajuan hutang: <strong id="rejectHutangNameKetua"></strong></p>
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                <textarea id="rejectCatatanKetua" name="catatan" rows="4" required
                ...
                <span class="text-red-500 text-sm error-message" id="error-reject-catatan-ketua"></span>
            </div>

            <!-- Buttons -->
            <div class="flex space-x-3 pt-4">
                <button type="button" onclick="closeRejectModalKetua()"
...
<style>
#rejectModalKetua.active {
    opacity: 1;
}

#rejectModalKetua.active > div {
    transform: scale(1);
}
</style>